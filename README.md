...
* **Mini-Applications (MERN Stack):** Small, focused apps like the **Mini-Chat** (built with Express, MongoDB, and EJS) that showcase full CRUD (Create, Read, Update, Delete) implementation.
* **Modern UI/UX Designs:** Projects prioritizing aesthetically pleasing, responsive, and highly interactive user interfaces, utilizing advanced CSS techniques (like Flexbox, Grid, and gradients).
...
| :--- | :--- |
| **Backend/Full-Stack** | Node.js, Express.js, MongoDB (MERN Stack components) |
